...
describe('AnnotationToolbar', () => {
  ...
  it('should render when selection exists and canCreate is true', async () => {
    const { container } = render(
      <div>
        <div className="document-text">This is some document text</div>
        <AnnotationToolbar {...defaultProps} />
      </div>
    );
